...
<html lang="es">
    <head>
        <meta charset="utf-8">
        <title>Acceso Cordoba web</title>
                                ...
                                <div class="d-flex flex-column h-100">
                                    ...
                                    <div class="auth-content my-auto">
                                        <div class="text-center">
                                            <h5 class="mb-0"> Cordoba web</h5>
                                            <p class="text-muted mt-2">Ingrese a la plataforma</p>
                                        </div>
                                            ...
                                            <div class="mb-3">
                                                <div class="d-flex align-items-start">
                                                    ...
                                                    <div class="flex-shrink-0">
                                                        <div class="">
                                                            <a href="assets/email/recuperar.html" class="text-muted">Olvidaste tu contraseña?</a>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="mt-5 text-center">
                                            <p class="text-muted mb-0">No tienes cuenta? <a href="view/registro/index.php" class="text-primary fw-semibold"> Registrate </a> </p>
                                        </div>
                                    </div>
                                    <div class="mt-4 mt-md-5 text-center">
                                        <p class="mb-0">© <script>document.write(new Date().getFullYear())</script> Victor Córdoba</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                                                        ...
                                                        <div class="mt-4 pt-3 pb-5">
                                                            <div class="d-flex align-items-start">
                                                                ...
                                                                <div class="flex-grow-1 ms-3 mb-4">
                                                                    ...
                                                                    <p class="mb-0 text-white-50">Estudiante de programación</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
